...
import { Row, Col, ModalHeader, Card, ModalFooter } from "react-bootstrap";
...
function DesignCard({ design, currentUser }) {
    ...
    axios
      .post(
        import.meta.env.VITE_REACT_APP_API_ENDPOINT +
          "portfolio/item/wishlist/update?current_user_id=" +
          current_user_id +
          "&token=" +
          token,
        e
  ...
  let designImage;
  if (design?.media.length && design.media?.[0]?.url) {
    designImage = design.media[0].url;
  } else {
      ...
      <Col className="designs-grid mb-3" xs="12" md="3">
        ...
        <div className="design-details">
          <div className="d-flex align-items-center justify-content-between">
            <p
              className="text-black cursor-pointer fs-18 fw-600 mb-0 text-ellipsis rufina-family design-name"
              onClick={function () {
                togglePortfolioImage(
                  design.id,
                  design.designer.id,
          ...
          >
            <div className="d-flex justify-content-center align-items-center user-image">
              ...
              <div className="ms-3">
                ...
                <div className="fashion-designer fs-16"> Designer</div>
              </div>
            </div>
          </a>
                      ...
                      <Card.Body className="action_container font-weight">
                        <Row>
                          <Col>
                            ...
                            <div className="mb-2 tw-pb-2 text-center">
                              {singleDesign.tags ? (
                                <>
                                  {singleDesign.tags.length > 0 ? (
                                    <>
                                      {singleDesign.tags.map((tag, index) => (
                                        <span
                                          key={index}
                                          className="design-tags bg-light fs-14 categories-color mt-2"
                                        >
                                          {tag}
                                        </span>
                                      ))}
