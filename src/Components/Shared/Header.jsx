...
const Header = () => {
  ...
  const getNotifications = async () => {
    return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'notification?user_id=' + currentUser + '?current_user_id=' + current_user_id + '&token=' + token);
  };
          ...
          <Navbar.Collapse className="justify-content-between column-gap-70" id="responsive-navbar-nav">
            <Nav className="align-items-center w-100">
              ...
              <Form onSubmit={searchSubmit} inline className='search-header w-100 d-flex align-items-center'>
                ...
                <FormControl type='text' placeholder='Search' name="search" onChange={handleChangeSearch} value={search} className='fs-12 search-bar-header ms-2 my-0' />
