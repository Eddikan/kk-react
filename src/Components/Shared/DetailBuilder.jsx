            ...
            {actionType == "edit" ?
                ...
                <>
                    ...
                    <div className="text-right">
                        {/* Add button */}
                        {elementType == "Line Break" ?
                            <Button className='btn-primary mt-4' type="button" onClick={handleAddElement}>Add</Button>
                            :
                            <Button className='btn-primary mt-4' type="button" onClick={handleAddElement} disabled={!elementType || !elementValue}>Add</Button>
                        }
                    </div>
                </>
