          ...
          <AccordionItem className="padding-sidebar pt-4">
            ...
            {is_designer && (
              <>
                ...
                <a
                  className="yellow-hover cursor-pointer text-decoration "
            ...
            {userDetails.is_seller == 1 && (
              <>
                <div
                  className="hover-sidebar cursor-pointer yellow-hover fs-14 mt-3"
                  onClick={() => navigate("/user/center/products")}
                >
                  <PiScissorsLight size="22" className="me-2 mb-1" />
                  Fabrics
                </div>
                ...
                <div className="mt-3 d-flex justify-content-between">
                  ...
                  <span className="shop-manager-table">
                    {module == "orders" && (
                      <>
                        <span>
                          <IoIosArrowDown className="me-4" color="#000000" />
                        </span>
                      </>
                    )}
                      ...
                      <Card.Body className="action_container font-weight">
                        <div className="shop_container cursor-pointer p-1 px-3">
                          <p
                            className={
                              currentTab == "All"
                                ? "active-class cursor-pointer mb-0 fw-600 text-gold"
                                : "cursor-pointer mb-0"
                            }
                        ...
                        <div className="shop_container cursor-pointer p-1 px-3">
                          <p
                            className={
                              currentTab == "Review"
                                ? "active-class cursor-pointer fw-600 mb-0 text-gold"
                                : "cursor-pointer mb-0"
                            }
            ...
            <Card className="mt-3 text-center">
              <Card.Body>
                <p className="text-center fw-600">
                  Help Us Improve <br />{" "}
                  <p className="mb-0 fw-400">Share Your Experience</p>
                </p>
