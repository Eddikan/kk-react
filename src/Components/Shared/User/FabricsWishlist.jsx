                                                        ...
                                                        <Col className="designs-grid mb-3" xs="12" md="6" key={index}>
                                                            <div className="bg-lgray rounded p-3">
                                                                <div className="portfolio-link">
                                                                    <Row>
                                                                        <Col lg="4" xs="12">
                                                                            <div className="designs-grid-div w-100 cursor-pointer" onClick={function () { toggleAddViewCount(wishlist.product.id); navigate('/product/' + wishlist.product.id); }} style={{ backgroundImage: "url(" + wishlistImage + ")", minHeight: '155px' }}>
                                                                            ...
                                                                            <div className="wishlist-details">
                                                                                ...
                                                                                {addToCartLoading && clickedCartButtonIndex == index ? (
                                                                                    <Button
                                                                                        ...
                                                                                        type="button"
                                                                                    >
                                                                                        <IoCartOutline size="20px"/> Adding to Cart...
                                                                                    </Button>
                                                                                ) : (
                                                                                    <Button
                                                                                        className="w-auto me-3 mt-2 btn-primary fs-16"
                                                                                    ...
                                                                                    >
                                                                                        <IoCartOutline size="20px"/> Add to Cart
                                                                                    </Button>
                                                                                )}
                                                                                {/* </>
                                                                                    :
