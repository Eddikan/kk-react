...
const Appointments = (props) => {
    ...
    const getAppointments = async () => {
        return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'user/' + currentUser + '/appointment?status='+status + '&current_user_id=' + current_user_id + '&token=' + token);
    };
    ...
    const handleChangePage = (pageNumber) => {
        axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'user/' + currentUser + '/appointment?page=' + pageNumber + '&current_user_id=' + current_user_id + '&token=' + token)
            .then((response) => {
    ...
    return (
        <>
            <div className="appointments-container">
                <p className='title-designer mb-1 lh-25'>Appointments </p>
                <div className="mt-15">
                    <Row className="mb-4">
                        <Col lg={12}>
                            <Card>
