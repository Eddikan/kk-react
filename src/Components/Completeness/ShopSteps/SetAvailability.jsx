...
const SetAvailability = ({ token, onStepPlusOne }) => {
  ...
  const handleAddSaturdayHours = async () => {
    setSaturdayHoursFormData((prevSaturdayHoursFormData) => [
  ...
  const BusinessHoursSubmitPut = (e) => {
    ...
    console.log("BusinessHoursSubmitPut", {
      selectedTimezone,
      content,
    });
    return;
    ...
    if (selectedTime) {
      ...
      if (
        ...
        if (sundayEntry && mondayEntry && tuesdayEntry) {
          ...
          const mappedWednesdayBusinessHours = wednesdayAvailabilities.map(
            (availability) => ({
              start: availability.start || "",
              end: availability.end || "",
            })
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                value={sunday?.start}
                                onChange={(e) =>
                                  handleChangeTimeSunday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  ...
                                  onClick={() => handleRemoveSundayHours(index)}
                                >
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                value={monday?.start}
                                onChange={(e) =>
                                  handleChangeTimeMonday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  className="cursor-pointer"
                                  onClick={() => handleRemoveMondayHours(index)}
                                >
                                  <RxCross2 color="#000000" />
                                </div>
                              </div>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                value={tuesday?.start}
                                onChange={(e) =>
                                  handleChangeTimeTuesday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  className="cursor-pointer"
                                  onClick={() =>
                                    handleRemoveTuesdayHours(index)
                                  }
                                >
                                  <RxCross2 color="#000000" />
                                </div>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                onChange={(e) =>
                                  handleChangeTimeWednesday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  className="cursor-pointer"
                                  onClick={() =>
                                    handleRemoveWednesdayHours(index)
                                  }
                                >
                                  <RxCross2 color="#000000" />
                                </div>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                onChange={(e) =>
                                  handleChangeTimeThursday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  className="cursor-pointer"
                                  onClick={() =>
                                    handleRemoveThursdayHours(index)
                                  }
                                >
                                  <RxCross2 color="#000000" />
                                </div>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                value={friday?.start}
                                onChange={(e) =>
                                  handleChangeTimeFriday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            {index > 0 && (
                              <div className="close-container">
                                <div
                                  className="cursor-pointer"
                                  onClick={() => handleRemoveFridayHours(index)}
                                >
                                  <RxCross2 color="#000000" />
                                </div>
                              </div>
                        ...
                        <>
                          {index > 0 && (
                            <div className="w-100 d-flex justify-content-end mt-3">
                              <div
                                className="cursor-pointer"
                                onClick={() => handleRemoveSaturdayHours(index)}
                              >
                                <RxCross2 color="#000000" />
                              </div>
                            </div>
                          ...
                          <Col md="5" className="pe-0 position-relative">
                            ...
                            <Form.Group className="mb-3">
                              <FormControl
                                ...
                                onChange={(e) =>
                                  handleChangeTimeSaturday(e, index)
                                }
                              />
                            </Form.Group>
                          </Col>
