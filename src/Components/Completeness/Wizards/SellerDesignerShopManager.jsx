...
const SellerDesignerShopManager = ({ progress }) => {
        ...
        <>
            <div className='wizard-cont'>
                ...
                <div className='progress-lines'>
                    {progress == 2 || progress == 3 || progress == 4 || progress == 5 || progress == 6?
                        <>
                    ...
                    {progress == 4 || progress == 5 || progress == 6 ?
                        <>
                            <div className='progress-line line-active'></div>
                        </>
                        :
...
export default SellerDesignerShopManager;
