...
const Orders = (props) => {
    ...
    const getOrders = async () => {
        return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'user/' + currentUser + '/order?status=' + orderStatus + '&current_user_id=' + current_user_id + '&token=' + token);
    };
