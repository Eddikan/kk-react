                                                                                    ...
                                                                                    <>
                                                                                        ...
                                                                                        {buyNowLoading ?
                                                                                            ...
                                                                                            <Button
                                                                                                ...
                                                                                                onClick={() => buyTempCart({ id: product.id, product_id: product.id, price: product.price, name: product.name, quantity: unitCount, user_first_name: product.user.first_name, user_last_name: product.user.last_name, user_image: product.user.image, user_phone_number: product.user.phone_number, user_country: product.user.country, user_country_code: product.user.country_code, user_province: product.user.province, user_province_code: product.user.province, user_city: product.user.city, user_postal_code: product.user.postal_code, user_address_line_1: product.user.address_line_1, user_id: product.user.id,  total: unitCount * product.price, unit_measurement: product.unit_measurement, images: product.image_urls[0] })}
                                                                                            >
                                                                                                Buy Now
                                                                                            </Button>
                                                                                        }
