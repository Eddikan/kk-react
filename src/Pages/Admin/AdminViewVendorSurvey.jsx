            ...
            getVendorFeedBack()
                .then((response) => {
                    ...
                    if (selectedVendorSurvey) {
                        setVendorFeedback(selectedVendorSurvey);
                        setVendorFormData(selectedVendorSurvey);
                        if (selectedVendorSurvey.user) {
                            setSurveyUser(selectedVendorSurvey.user);
                        }
                    } else {
...
export default AdminViewVendorSurvey;