                                ...
                                <Col lg={10} className='py-5 mx-auto max-width-column padding-right-admin'>
                                    <Row>
                                        <Col lg={12}>
                                            <Row className="pb-4">
                                                <Col md={6} className='d-flex justify-content-left align-items-center'>
                                                    <h3 className="fs-30 fw-600 text-black mb-0">Post Purchase Survey</h3>
                                                </Col>
                                        ...
                                        <>
                                            {postPurchases ?
                                                <>
                                                    {postPurchases.length > 0 ?
                                                        <>
                                                            {postPurchases.map((postPurchase) => {
                                                                ...
                                                                const today = (new Date(postPurchase.created_at)).toLocaleDateString('en-ES', options);
                                                                        ...
                                                                        <Card className='mt-3'>
                                                                            <Card.Body >
                                                                                <Row className="align-items-center">
                                                                                    ...
                                                                                    <Col lg={2}>
                                                                                        <span className='text-black'>{postPurchase.status}</span>
                                                                                    </Col>

                                                                                    <Col lg={2} className='d-flex justify-content-end'>
                                                                                        <Link to={`/admin/view/post-purchase-survey/${postPurchase.id}`} className="text-decoration-none">
...
export default AdminSurveyAnswers;