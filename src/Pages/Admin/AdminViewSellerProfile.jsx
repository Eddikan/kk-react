...
const ViewSellerProfile = () => {
    ...
    const [seller, setSeller] = useState(initialDesignerData);
    ...
    async function updateProfilePicture(e) {
        axios.put(process.env.REACT_APP_API_ENDPOINT + 'user/' + sellerId + '?user_id=' + sellerId + '&token=' + token, {
            ...
            if (success == 'Success') {
                ...
                if (user.seller) {
                    setCookie('currentUserDesigner', JSON.stringify(user.seller.id), { path: '/' });
                }
                if (user.seller) {
    ...
    useEffect(() => {
        ...
        fetchData({ token: token, currentUser: sellerId });
            ...
            {userLoading ?
                ...
                <section id='profile' className='py-5 px-2'>
                    <Container>
                        ...
                        {myCalendarShow ?
                            <div id="profile-portfolio">
                                <MyCalendar designerId={seller?.id} />
                            </div>
                            :
                            null
                        }
