                                                                            ...
                                                                            <Col lg={12}>
                                                                                <Card className='mt-2 border-card'>
                                                                                    <Card.Header className='order-chat d-flex justify-content-between'>
                                                                                        <div>
                                                                                            <a href={`/admin/order/${order.id}/details`} className="cursor-pointer text-decoration-none" >
                                                                                    ...
                                                                                    <Card.Body className='bg-white card-body-border'>
                                                                                        <Row>
                                                                                            ...
                                                                                            <Col className='text-right'>
                                                                                                <a href={`/admin/order/${order.id}/details`} className="cursor-pointer check-datails-decoration" >
