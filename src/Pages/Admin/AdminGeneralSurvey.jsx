...
const AdminGeneralSurvey = (props) => {
    ...
    const getGeneralSurvey = async () => {
        return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'general-feedback-survey');
    };
    ...
    const handleChangePage = (pageNumber) => {
        axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'general-feedback-survey?page=' + pageNumber + '&user_id=' + currentUser)
            .then((response) => {
                                        ...
                                        <Col lg={12}>
                                            <Row className="pb-4">
                                                <Col md={6} className='d-flex justify-content-left align-items-center'>
                                                    <h3 className="fs-30 fw-600 text-black mb-0">General FeedBack Survey</h3>
                                                </Col>
                                            ...
                                            {generalFeedBacks ?
                                                <>
                                                    {generalFeedBacks.length > 0 ?
                                                        <>
                                                            {generalFeedBacks.map((generalFeedBack) => {
                                                                ...
                                                                const today = (new Date(generalFeedBack.created_at)).toLocaleDateString('en-ES', options);
                                                                        ...
                                                                        <Card className='mt-3'>
                                                                            <Card.Body >
                                                                                <Row className="align-items-center">
                                                                                            ...
                                                                                            <div className='d-flex survey-user-image'>
                                                                                                {generalFeedBack.user?.image != '' && generalFeedBack.user?.image != null ? (
                                                                                                    <div
                                                                                                        ...
                                                                                                        style={{ backgroundImage: `url(${import.meta.env.VITE_REACT_APP_STORAGE_URL}user/${generalFeedBack.user?.image})` }}
                                                                                                    >
                                                                                                    </div>
                                                                                                ) : (
                                                                                    ...
                                                                                    <Col lg={2}>
                                                                                        <span className='text-black'>{generalFeedBack.status}</span>
                                                                                    </Col>

                                                                                    <Col lg={2} className='d-flex justify-content-end'>
                                                                                        <Link to={`/admin/view/general-feedback-survey/${generalFeedBack.id}`} className="text-decoration-none">
...
export default AdminGeneralSurvey;