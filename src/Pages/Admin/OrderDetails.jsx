...
const OrderDetails = (props) => {
        ...
        getOrder()
            .then((response) => {
                ...
                if (selectedOrder) {
                    ...
                    setUser(selectedOrder[0].customer);
                    setOrderLoading(false);
                } else {
    ...
    const getOrderItemLog = async (order_item_id) => {
        return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'order/item/'+order_item_id+'/log');
    };
                                                                        ...
                                                                        <Card.Header className='order-chat d-flex justify-content-between'>
                                                                            <div>
                                                                                <div className='d-flex align-items-center user-image-order'>
                                                                                    ...
                                                                                    <div className=''>
                                                                                        <strong> 
                                                                                            {order.order_items[0].product.user.first_name}  
                                                                                            {order.order_items[0].product.user.last_name} 
                                                                                            </strong>
                                                                                            </div>
                                                                                    </div>
                                                                            </div>
