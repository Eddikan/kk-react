                        ...
                        <Col lg={12} className='mx-auto py-5 max-width-column'>
                            <div>
                                <Row>
                                    ...
                                    <Col md={`${(userDetails.is_designer == 1 && userDetails.is_seller == 0 && step != 4 || userDetails.is_seller == 1 && userDetails.is_designer == 0 && step != 3 || userDetails.is_designer == 1 && userDetails.is_seller == 1 && step != 5 ) ? '9' : '12'}`} className='flex-grow-1 flex-shrink-0'>
                                        <Card className='h-100'> 
