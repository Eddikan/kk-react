...
import { measurementGuideData } from "Utils/assets";
...
const EditProfile = () => {
  ...
  const [areasOfSpecializationData, setAreaOfSpecializationData] = useState(
    initialDesignerData.areas_of_specialization
  );
  ...
  const getCoordinates = async (requestData) => {
    ...
    try {
      ...
      if (response.status == 200) {
        ...
        toast.error(
          "Failed to fetch coordinates. Please check the city name and try again."
        );
      }
  ...
  const getCountryStates = async (requestData) => {
    try {
      ...
      const response = await axios.post(
        import.meta.env.VITE_REACT_APP_LOCATION_API_ENDPOINT +
          "countries/states",
      ...
      if (!error) {
        ...
        if (errors) {
          setErrors(errors);
          toast.error(
            "There has been an error getting the states, please try again!"
          );
        } else {
          toast.error(
            "There has been an error getting the states, please try again!"
    ...
    try {
      ...
      if (!error) {
        ...
        if (errors) {
          setErrors(errors);
          toast.error(
            "There has been an error getting the cities, please try again!"
          );
        } else {
          toast.error(
            "There has been an error getting the cities, please try again!"
    ...
    axios
      ...
      .then((response) => {
        ...
        if (success == "Success") {
          ...
          setCookie("userCurrency", JSON.stringify(user.currency ?? "USD"), {
            path: "/",
          });
          setCookie(
            "userCurrencyCode",
      ...
      axios
        .put(
          import.meta.env.VITE_REACT_APP_API_ENDPOINT +
            ...
            "&token=" +
            token,
          { areas_of_specialization: areasOfSpecializationData }
        )
        .then((response) => {
          const success = response.data.status;
          if (success == "Success") {
    ...
    try {
      ...
      if (userData.id) {
        ...
        if (userData.designer) {
          ...
          setAreaOfSpecializationData(
            userData.designer.areas_of_specialization
          );
        }
      } else {
        setUserLoading(false);
              ...
              <Row className="d-flex">
                <Col md="3" className="flex-grow-1 flex-shrink-0">
                  <Card className="h-100">
                    <Card.Body>
                      <p
                        className={`cursor-pointer me-5 mb-3 fs-16 ${
                          profileShow ? "fw-600 text-gold" : "text-black"
                        }`}
                        onClick={function () {
                          showTab("profile");
                        }}
                      ...
                      <p
                        className={`cursor-pointer me-5 mb-3 fs-16 ${
                          addressShow ? "fw-600 text-gold" : "text-black"
                        }`}
                        onClick={function () {
                          showTab("address");
                        }}
                      ...
                      <p
                        className={`cursor-pointer me-5 mb-3 fs-16 ${
                          contactShow ? "fw-600 text-gold" : "text-black"
                        }`}
                        onClick={function () {
                          showTab("contact");
                        }}
                      ...
                      <p
                        className={`cursor-pointer me-5 mb-3 fs-16 ${
                          socialMediaShow ? "fw-600 text-gold" : "text-black"
                        }`}
                        onClick={function () {
                          showTab("social_media");
                        }}
                      >
                        Social Media
                      </p>
                      {user && user.is_designer ? (
                        <p
                          className={`cursor-pointer me-5 mb-3 fs-16 ${
                            skillShow ? "fw-600 text-gold" : "text-black"
                          }`}
                          onClick={function () {
                            showTab("skill");
                          }}
                            ...
                            <Col lg="12">
                              ...
                              <Form.Group>
                                ...
                                <FormControl
                                  ...
                                  name="short_bio"
                                  maxLength="250"
                                  value={profileFormData.short_bio}
                                  className="mr-sm-2"
                                  onChange={handleChange}
                                  placeholder=""
                                />
                              ...
                              <p className="text-muted ms-1 fs-12 mb-4">
                                ...
                                {250 - profileFormData.short_bio.length}{" "}
                                characters left)
                              </p>
                              <Form.Group className="mb-3">
                                <Form.Label>
                      ...
                      {skillShow ? (
                        <div className="edit-skills">
                          ...
                          <Form.Label className="mb-3 mt-2 small d-block">
                            Specify your areas of expertise (e.g., bridal wear,
                            ready-to-wear women’s clothing, casual, haute
                          ...
                          <Form.Group>
                            <TagsInput
                              ...
                              onBlur={(e) => {
                                ...
                                if (
                                  !areasOfSpecializationData.includes(value) &&
                                  value !== ""
                                ) {
                                  setAreaOfSpecializationData([
                                    ...areasOfSpecializationData,
                                    value,
                                  ]);
                                  e.target.value = "";
                                }
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        onClick={() =>
                                          toggleMeasurementGuideModal(47)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.upper_neck_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(48)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.lower_neck_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(49)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(50)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(51)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.mid_hip_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(52)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(53)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(54)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(55)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(56)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(57)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(58)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(59)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(60)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(61)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(62)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(63)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(64)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(65)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(66)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(67)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(68)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(69)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(70)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.armhole_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(71)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(72)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(73)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(74)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(75)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(76)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(77)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(78)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.mid_thigh_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(79)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(80)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(81)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(82)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.ankle_heel_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(83)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(84)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                ...
                                <Col lg="6">
                                  <Form.Group className="mb-3">
                                    ...
                                    <Form.Control
                                      ...
                                      placeholder=""
                                      value={
                                        checklistData.under_bust_circumference
                                      }
                                    />
                                  </Form.Group>
                                </Col>
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(10)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(11)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(12)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(13)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(14)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(15)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(16)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(17)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(18)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(19)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(20)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(21)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(22)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(23)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(24)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(25)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(26)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(27)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(28)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(29)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(30)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(31)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(32)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(33)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(34)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(35)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(36)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(37)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(38)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(39)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(40)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(41)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(42)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(43)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(44)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(45)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
                                  ...
                                  <Form.Group className="mb-3">
                                    <Form.Group>
                                      ...
                                      <IoIosHelpCircleOutline
                                        ...
                                        className="question-btn"
                                        onClick={() =>
                                          toggleMeasurementGuideModal(46)
                                        }
                                      />
                                    </Form.Group>
                                    <Form.Control
