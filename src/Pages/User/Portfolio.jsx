              ...
              {portfolio && portfolio.length > 0 ? (
                <>
                  <Row className="portfolio-row bg-portfolio">
                    ...
                    <Col
                      lg={10}
                      className="py-5 mx-auto padding-right-admin max-width-column"
                    >
                      <div>
                        <Row>
                          <Col lg={12}>
                        ...
                        <Row>
                          {portfolio.map((object, index) => (
                            <Col
                              key={object.id}
                              className={`portfolio-grid-image mb-4`}
                              xs="4"
                              md="2"
                            >
                              <div
                                className={`portfolio-grid-div w-100 ${
                                    ...
                                    {true && (
                                      <div className="action-box">
                                        <Link
                                          ...
                                          to={`/user/center/design/${object.id}/edit`}
                                        >
                                          <p className="mb-3 text-decoration-none">
                                            <GoPencil className="mb-1" /> Edit
                                          </p>
                                        </Link>

                                        <p
                                          className="mb-3 text-decoration-none cursor-pointer"
                                          onClick={function () {
                                        ...
                                        <p
                                          ...
                                          onClick={function () {
                                            deleteConfirm(object.id);
                                          }}
                                        >
                                          <GoTrash className="mb-1" /> Delete
                                        </p>
                                        {object.status != "Draft" ? (
                                          <p
                                            className="mb-0 cursor-pointer"
                                            onClick={function () {
                                              PortfolioDraftSubmit(object.id);
                                            }}
                                          >
                                            <IoDocumentOutline />{" "}
                                          ...
                                          <p
                                            className="mb-0 cursor-pointer"
                                            onClick={function () {
                                              PortfolioPublishSubmit(object.id);
                                            }}
                                          >
                                            <IoDocumentOutline />{" "}
                                            {portfolioPublishLoading
                                              ? "Publishing..."
                                              : "Publish"}
                                          </p>
                                        )}
                              ...
                              <Row>
                                <Col lg="6">
                                  <div className="text-black text-decoration-none ellipsis-portfolio-seller rufina-family fs-18 mt-2">
                                    {object.name ?? "-"}
                                  </div>
                                </Col>
                                ...
                                <Col lg="6" className="text-end">
                                  {object.views == null ? (
                                    <div className="mt-2">
                                      <IoEyeOutline className="text-black ms-2" />{" "}
                                      0
                                    </div>
                                  ) : (
                                    <div className="mt-2">
                                  ...
                                  <Card.Body className="image-drop-container pt-5 pb-5">
                                    <div className="text-center">
                                      ...
                                      <p className="text-center mb-3">
                                        Showcase your best works, enrich your
                                        portfolio, and join a flourishing
                                        community.
                                      </p>
                                ...
                                >
                                  <Card className="h-100">
                                    <Card.Body className="pt-4">
                                      <UploadPortfolio shopManagerPage />
                                    </Card.Body>
                                  </Card>
                                </Col>
                              </Col>
                          ...
                          <Col>
                            <div className="user-image-modal text-center">
                              ...
                              singleDesign.image !== "-" ? (
                                ...
                                <img
                                  src={UserPlaceholder}
                                  className="placeholder-img-side mb-3"
                                />
                              )}
                            </div>
                                  ...
                                  {singleDesign.tags.length > 0 ? (
                                    <>
                                      {singleDesign.tags.map((tag, index) => (
                                        <span
                                          key={index}
                                          className="design-tags bg-light fs-14 categories-color"
                                        >
                                          {tag}
                                        </span>
                                      ))}
                            ...
                            {isDesignCurrentUser ? null : (
                              <>
                                ...
                                <div
                                  ...
                                  onClick={() => {
                                    toggleUnderConstruction("Message");
                                    setProfileViewShow(false);
                                  }}
                                >
                ...
                <div>
                  ...
                  >
                    {singleDesign.image !== "" && singleDesign.image !== "-" ? (
                      ...
                      <img
                        src={UserPlaceholder}
                        className="placeholder-img-side mb-4"
                      />
                    )}
                  </div>
                </div>
                            ...
                            <div className="d-flex user-image-share image-share-popup">
                              ...
                              <div className="ms-2">
                                <div className="modal-title text-left fs-16 fw-600 text-white">
                                  {singleDesign.first_name}{" "}
                                  {singleDesign.last_name}
                                </div>
                                <div>
                                  {singleDesign.tags ? (
                                    <>
