...
import BecomeDesignerFrom from 'Components/CallToActions/DesignerForm';
  ...
  return (
    <Layout>
        <Container className='q3 q2-no text-dgray'>
            <BecomeDesignerFrom currentUser={currentUser} user={user} onReloadPage={reloadPage} onHideAll={hideAll} step={step} />
        </Container>
    </Layout>
  );
};
