...
const Orders = (props) => {
    ...
    const getOrders = async () => {
        return await axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'user/' + currentUser + '/seller/order?page='+currentPage+'&status=' + currentTab);
    };
    ...
    const handleChangePage = (pageNumber) => {
        ...
        axios.get(import.meta.env.VITE_REACT_APP_API_ENDPOINT + 'user/' + currentUser + '/seller/order?status=' + currentTab+'&user_id=' + currentUser +'&page='+pageNumber)
            .then((response) => {
